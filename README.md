...
``` typescript
import * as pkg from 'https://unpkg.com/@bevry/list@^1.1.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/list@^1.1.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/list@^1.1.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/list@1.1.0'
</script>
```
